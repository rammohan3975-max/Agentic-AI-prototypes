# Create Weather Buddy that sends direct email notification instead of Teams
# Since personal Teams accounts don't support webhooks or bots, we'll use email
...
# Save the code
with open('weather_buddy_email.py', 'w') as f:
    f.write(weather_buddy_email)

print("✅ Weather Buddy Email Version Generated!")
print("\n📁 File created: weather_buddy_email.py")
print("\n🎯 What this does:")
print("- Hardcoded weather: Cloudy now, heavy rain in 2-4 hours")
print("- Checks 3 meetings scheduled for today")
print("- Sends beautifully formatted EMAIL notification to rammohan3975@gmail.com")
print("- Works with personal Gmail accounts (no Teams webhook needed)")
print("\n🚀 To run:")
print("1. Install: pip install python-dotenv")
print("2. Create .env file with Gmail App Password (optional for actual sending):")
print("   SENDER_EMAIL=rammohan3975@gmail.com")
print("   SENDER_APP_PASSWORD=your_16_char_app_password")
print("3. Run: python weather_buddy_email.py")
print("\n📧 Email will be sent to: rammohan3975@gmail.com")
print("\n💡 If no app password configured, notification will display in console")